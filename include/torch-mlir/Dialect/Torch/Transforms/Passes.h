...
std::unique_ptr<OperationPass<func::FuncOp>> createInsertConvPass(std::string net, int layer);

std::unique_ptr<OperationPass<func::FuncOp>> createInsertLinearPass(std::string net, int layer);
