...
general_obfuscation = {
    ...
    "b": "torch-insert-conv{layer=1}",
    "c": "torch-insert-sepra-conv-layer{layer=1}",
    "d": "torch-insert-linear{layer=1}",
    "e": "torch-value-split{number=2 layer=1}",
    "f": "torch-mask-split{number=2 layer=1}",
    "g": "torch-insert-Inception{number=1 layer=1}",
    "h": "torch-insert-RNN{number=1 layer=1}",
...
# 定义问题
obfuscation_name = [
    ["a", "layer=1"], ["b", "layer=1"], ["c", "layer=1"], ["d", "layer=1"], 
    ["e", "number=2", "layer=1"], ["f", "number=2", "layer=1"], ["g", "number=1", "layer=1"], 
    ["h", "number=1", "layer=1"], ["i", "activationFunc=tanh", "number=1", "layer=1"]
]
obfuscation_name_layer = ["a", "b", "c", "d"]
obfuscation_name_num_layer = ["e", "f", "g", "h"]
